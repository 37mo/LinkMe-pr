  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-pink-50 to-blue-50">
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 py-8 sm:py-12">
        {/* Hero Section */}
        <div className="bg-white/90 backdrop-blur-sm rounded-2xl sm:rounded-3xl shadow-lg p-4 sm:p-8 mb-6 sm:mb-8 border border-pink-100">
          <div className="text-center mb-8">
            <div className="text-sm text-pink-400 font-medium mb-4 bg-pink-50 px-4 py-2 rounded-full inline-block">
              ✨ PRESS RELEASE ✨
            </div>
            <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-800 mb-4 sm:mb-6 leading-tight sm:leading-relaxed">
              あなたにぴったりのイベントが、 
              <br />
              もう探さなくても見つかる 💫
              <br />
            ...
            <p className="text-lg sm:text-xl text-gray-600 leading-relaxed bg-pink-50 p-3 sm:p-4 rounded-xl sm:rounded-2xl">
              新しい街でも、自分に合った出会いを。
              <br />
        ...
        <div className="space-y-6">
          {/* Section 1 */}
          <div className="bg-white/90 backdrop-blur-sm rounded-2xl shadow-sm p-4 sm:p-8 border border-pink-100">
            <div className="flex flex-col sm:flex-row items-start space-y-4 sm:space-y-0 sm:space-x-6">
              ...
              <div className="flex-1">
                <h2 className="text-lg sm:text-xl font-bold text-gray-800 mb-3 sm:mb-4 text-center sm:text-left flex items-center justify-center sm:justify-start">
                  革新的なマッチング機能 <span className="ml-2">✨</span>
                </h2>
                <p className="text-sm sm:text-base text-gray-700 leading-relaxed bg-pink-50 p-3 sm:p-4 rounded-xl text-center sm:text-left">
        ...
        <div className="bg-white/90 backdrop-blur-sm rounded-2xl sm:rounded-3xl p-6 sm:p-12 text-center mt-8 sm:mt-12 shadow-lg border border-pink-100">
          <div className="text-4xl sm:text-5xl mb-3 sm:mb-4">🎉</div>
          <h2 className="text-xl sm:text-2xl font-bold mb-3 sm:mb-4 text-gray-800 px-2">LinkMeで新しい出会いを始めませんか？</h2>
          ...
          <div className="bg-pink-50 rounded-2xl p-4 sm:p-8 max-w-md mx-auto mb-4 sm:mb-6 border border-pink-200">
            <h3 className="text-lg sm:text-xl font-bold mb-3 sm:mb-4 text-gray-800">✨ 先行登録受付中 ✨</h3>
      ...
      {/* Footer */}
      <footer className="bg-gradient-to-r from-pink-100 to-pink-200 py-8 sm:py-12">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center">
          <div className="text-2xl sm:text-3xl font-bold mb-3 sm:mb-4 font-pacifico text-pink-400">LinkMe</div>
          <p className="text-sm sm:text-base text-gray-700 mb-4 sm:mb-6 px-2">あなたにぴったりのイベントをお届けします 💕</p>
    
          <div className="mt-6 sm:mt-8 pt-6 sm:pt-8 border-t border-pink-200 text-gray-600 text-xs sm:text-sm">
            <div className="mb-2">
              運営会社：
              <a 
                href="https://37mo.com/" 
